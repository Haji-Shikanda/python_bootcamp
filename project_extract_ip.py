...
# Extracting the ipv4, ipv6 and the mac address of the attached string interface
# Both into a list and a string
# It can be used for documentation or setting up a firewall
